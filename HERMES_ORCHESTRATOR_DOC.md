...
Hermes Orchestrator — это центральный компонент AI-системы мессенджера Lavender. Он принимает запросы пользователей через gRPC, анализирует их, маршрутизирует к подходящим AI-агентам и стримит ответы обратно.
