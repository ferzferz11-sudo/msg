...
**Текущая версия:** v1.1.3.0 (сервер) / v1.1.3.29 (Android)
**Обновлено:** 2026-06-17 (сессия 35)
**Тег:** v1.1.3.29 (Android, не выпущен)
...
**Текущая ветка сервера:** `feat/1.2.0.x`
**Текущая ветка Android:** `feat/1.1.3.x`
...
|-----------|--------|--------|
| Сервер dev | ✅ работает | v1.1.3.0 |
| Сервер prod | ✅ стабилен | v1.1.3.0 |
| Android | ✅ компилируется | v1.1.3.29 |
| AuthService v2 (JWT) | ✅ dev only | 2.0 |
| ProfileService v2 | ✅ dev only | 2.0 |
| ChatList v2 | ✅ dev only | 2.0 |
| ChatStream v2 | ✅ dev only | 2.0 |
| FCM Push | ✅ работает | 1.0 |
| RealGrpcClient модули | ✅ 12 модулей | — |
| NewChatBottomSheet | ✅ 7 пунктов | — |
| Favorites tab | ✅ добавлен | — |
| Toolbar theming | ✅ полная адаптация | — |
...
## Промпт для следующей сессии (v1.1.3.30)

```
ЗАДАЧА: Продолжить работу над Lava Messenger. v1.1.3.29 завершена.

Текущая версия: v1.1.3.29 (Android), v1.1.3.0 (сервер)
Следующая версия: v1.1.3.30

Контекст:
- Android: /root/msg.client.android, ветка feat/1.1.3.x
- Сервер: /root/msg, ветка feat/1.1.4.x
- Dev сервер: порт 50052, prod сервер: порт 50051

Что сделано в v1.1.3.29:
- NewChatBottomSheet с полным меню (7 пунктов)
- Favorites в табах
- Полная адаптация тулбара к кастомным темам

ЗАДАЧИ НА СЛЕДУЮУ СЕССИЮ (v1.1.3.30):
