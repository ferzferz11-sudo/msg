...
**Текущая версия:** v1.2.0.2 (dev) / v1.1.3.27 (Android)
**Обновлено:** 2026-06-17 (сессия 33)
**Тег:** v1.1.3.27 (Android, не выпущен)
...
|-----------|--------|--------|
| Сервер dev | ✅ работает | v1.2.0.2 |
| Сервер prod | ✅ стабилен | v1.1.3.10 |
| Android | ✅ компилируется | v1.1.3.27 |
...
| RealGrpcClient модули | ✅ 10 модулей | — |
