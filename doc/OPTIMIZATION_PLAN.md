...
**Версия сервера:** 1.3.0.2 | **Дата:** 2026-06-20 | **Ветка:** feat/1.3.0.x
...
| 49 | Usage stats (token tracking, ai_usage_stats) | ✅ Done | `ai_v2.go`, `db_ai_v2.go` |
| 50 | Agent marketplace (reviews, ratings, share, install) | ✅ Done | `db_ai_v2.go`, `server_ai_v2.go` |
