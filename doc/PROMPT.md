...
**Статус:** v1.3.3.2 задеплоен. Push notifications fix + call disconnect fallback.
...
| | Версия | Статус |
|---|--------|--------|
| **Сервер prod** | v1.3.3.2 | ✅ Работает на порту 50051 |
| **Сервер dev** | v1.3.3.2 | ✅ Работает на порту 50052 |
