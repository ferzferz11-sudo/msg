...
**Дата:** 2026-06-14 (сессия 3)
**Версия:** v1.1.3.11
**Ветка:** feat/1.1.3.x

---

## СТАТУС: v1.1.3.11 — DEV (двойной вход исправлен)

Android: исправлен баг двойного входа при смене сервера.
Сервер: v1.1.3.10 на prod и dev.
