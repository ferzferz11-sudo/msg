...
**Статус:** v1.3.3.1 задеплоен. Password reset, MarkRead, auth fixes, chatlist/AI fields.
...
| | Версия | Статус |
|---|--------|--------|
| **Сервер prod** | v1.3.3.1 | ✅ Работает на порту 50051 |
| **Сервер dev** | v1.3.3.1 | ✅ Работает на порту 50052 |
