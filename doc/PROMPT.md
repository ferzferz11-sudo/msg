# Промпт для серверных сессий — v1.3.2.1

**Дата:** 2026-07-05 | **Ветка:** feat/1.3.0.x
**Статус:** v1.3.2.1 задеплоен. Bug fixes: UpdateChatParticipants, DeleteCompany FK, CreateGroupChat type field.
...
| | Версия | Статус |
|---|--------|--------|
| **Сервер prod** | v1.3.2.1 | ✅ Работает на порту 50051 |
| **Сервер dev** | v1.3.2.1 | ✅ Работает на порту 50052 |
