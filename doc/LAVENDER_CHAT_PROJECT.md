# Лава Chat — Полноценная замена Telegram внутри Лава

## Цель
Сделать так, чтобы весь рабочий общение (включая общение с OWL AI) происходило через Лава, без необходимости переключаться на Telegram. Лава становится единным мессенджером для всего.
...
**Что сделать:**
- Показывать серверные уведомления в отдельном чате "Лава Server"
