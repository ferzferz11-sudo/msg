...
const (
	...
	ChatService_GenerateAgentToken_FullMethodName     = "/messenger.ChatService/GenerateAgentToken"
	ChatService_RevokeAgentToken_FullMethodName       = "/messenger.ChatService/RevokeAgentToken"
	ChatService_ListAgentTokens_FullMethodName        = "/messenger.ChatService/ListAgentTokens"
...
func (c *chatServiceClient) GenerateAgentToken(ctx context.Context, in *GenerateAgentTokenRequest, opts ...grpc.CallOption) (*GenerateAgentTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GenerateAgentTokenResponse)
	err := c.cc.Invoke(ctx, ChatService_GenerateAgentToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) RevokeAgentToken(ctx context.Context, in *RevokeAgentTokenRequest, opts ...grpc.CallOption) (*RevokeAgentTokenResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RevokeAgentTokenResponse)
	err := c.cc.Invoke(ctx, ChatService_RevokeAgentToken_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *chatServiceClient) ListAgentTokens(ctx context.Context, in *ListAgentTokensRequest, opts ...grpc.CallOption) (*ListAgentTokensResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ListAgentTokensResponse)
	err := c.cc.Invoke(ctx, ChatService_ListAgentTokens_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedChatServiceServer) GenerateAgentToken(context.Context, *GenerateAgentTokenRequest) (*GenerateAgentTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method GenerateAgentToken not implemented")
}
func (UnimplementedChatServiceServer) RevokeAgentToken(context.Context, *RevokeAgentTokenRequest) (*RevokeAgentTokenResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method RevokeAgentToken not implemented")
}
func (UnimplementedChatServiceServer) ListAgentTokens(context.Context, *ListAgentTokensRequest) (*ListAgentTokensResponse, error) {
...
func _ChatService_GenerateAgentToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GenerateAgentTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).GenerateAgentToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_GenerateAgentToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).GenerateAgentToken(ctx, req.(*GenerateAgentTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatService_RevokeAgentToken_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(RevokeAgentTokenRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).RevokeAgentToken(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_RevokeAgentToken_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).RevokeAgentToken(ctx, req.(*RevokeAgentTokenRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ChatService_ListAgentTokens_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ListAgentTokensRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServiceServer).ListAgentTokens(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ChatService_ListAgentTokens_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServiceServer).ListAgentTokens(ctx, req.(*ListAgentTokensRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _ChatService_GenerateAgentToken_Handler,
		},
		{
			MethodName: "RevokeAgentToken",
			Handler:    _ChatService_RevokeAgentToken_Handler,
		},
		{
			MethodName: "ListAgentTokens",
			Handler:    _ChatService_ListAgentTokens_Handler,
		},
		{
